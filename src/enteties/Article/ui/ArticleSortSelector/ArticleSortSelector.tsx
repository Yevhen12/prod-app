...
const ArticleSortSelector: FC<ArticleSortSelectorProps> = ({
  ...
  return (
    <div className={classNames(cls.articleSortSelector, {}, [className])}>
      <Select options={sortFieldOptions} label={t('sortOn')} value={sort} onChange={onChangeSort} />
      <Select options={orderOptions} className={cls.order} label={t('on')} value={order} onChange={onChangeOrder} />
    </div>
  )
}
