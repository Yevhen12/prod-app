...
export const getArticleRecommendations = articleDetailsPageRecommendationAdapter.getSelectors<StateSchema>(
  (state) => state.articleDetailsPage?.recommendations ?? articleDetailsPageRecommendationAdapter.getInitialState()
)

const articleDetailsPageRecommendationSlice = createSlice({
  name: 'articleDetailsPageRecommendation',
  initialState: articleDetailsPageRecommendationAdapter.getInitialState<ArticleDetailsPageRecommendationSchema>({
    isLoading: false,
    ids: [],
    entities: {},
    error: undefined
...
export const { reducer: articleDetailsPageRecommedationReducer } = articleDetailsPageRecommendationSlice
