...
export const resetProfile = (profileId: string) => {
  return cy.request<User>({
    ...
    body: {
      ...
      username: 'ulbi tv',
      avatar:
        'https://images.unsplash.com/photo-1702627587052-c0d39b978d29?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    },
  });
};
